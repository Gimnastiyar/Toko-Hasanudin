        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header
                ...
                <div class="w-1/3 flex justify-center">
                    <h1
                        class="text-2xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400 drop-shadow-sm">
                        TOKO HASAN
                    </h1>
                </div>
                    ...
                    <div class="flex items-center gap-3 pl-5 border-l border-slate-200 dark:border-slate-700">
                        <div class="hidden md:block text-right">
                            <p class="text-sm font-semibold text-slate-700 dark:text-slate-200 leading-tight">
                                {{ auth()->user()->name ?? 'Kasir' }}</p>
                            <p
                                class="text-[11px] text-emerald-600 dark:text-emerald-400 font-bold tracking-wide uppercase">
                                Kasir</p>
                        </div>
                        <div
                            class="h-9 w-9 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold shadow-md ring-2 ring-white dark:ring-slate-800">
                            {{ strtoupper(substr(auth()->user()->name ?? 'K', 0, 1)) }}
                        </div>
                    </div>
                </div>
