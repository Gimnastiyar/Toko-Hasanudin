...
<div class="max-w-3xl mx-auto pb-20 px-4 sm:px-6">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Tambah Pelanggan</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-2">Daftarkan pelanggan baru untuk memudahkan pencatatan transaksi.</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="status_customer" id="status_customer" required
                        ...
                        <option value="reguler" {{ old('status_customer') === 'reguler' ? 'selected' : '' }}>Reguler</option>
                        <option value="langganan" {{ old('status_customer') === 'langganan' ? 'selected' : '' }}>Langganan</option>
                    </select>
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="4"
                              ...
                              placeholder="Masukkan alamat lengkap pelanggan jika diperlukan...">{{ old('alamat') }}</textarea>
                </div>
            </div>
