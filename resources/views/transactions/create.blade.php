        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1">
            ...
            <div class="lg:col-span-5">
                <div class="bg-slate-900 rounded-3xl p-5 shadow-2xl sticky top-8 flex flex-col h-full lg:h-auto min-h-[500px] border border-slate-800 relative overflow-hidden">
                    ...
                    <div class="absolute top-0 right-0 -mr-16 -mt-16 w-32 h-32 bg-indigo-500/20 rounded-full blur-3xl"></div>
                    <div class="absolute bottom-0 left-0 -ml-16 -mb-16 w-32 h-32 bg-emerald-500/20 rounded-full blur-3xl"></div>
                    ...
                    <div class="relative z-10 flex-1 flex flex-col">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center justify-between bg-slate-800/50 p-1.5 rounded-xl border border-slate-700/50 backdrop-blur-sm">
                                ...
                                <button type="button" onclick="changeQty(1)"
                                    class="w-10 h-10 flex items-center justify-center bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg transition-colors font-bold text-xl shadow-inner active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed" id="btn-plus" disabled>
                                    +
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-800/50 p-3 rounded-xl border border-slate-700/50 backdrop-blur-sm mb-4">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <select id="discount_type" name="discount_type" onchange="calculate()" disabled
                                    class="w-full bg-slate-700 border border-slate-600 text-white text-[11px] rounded-lg px-2 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed">
                                ...
                                <input type="number" id="discount" name="discount" value="0" min="0" oninput="calculate()" disabled
                                    class="w-full bg-slate-700 border border-slate-600 text-white text-[11px] rounded-lg px-2 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed placeholder-slate-400 text-center"
                                    placeholder="0">
                            </div>
                        </div>
